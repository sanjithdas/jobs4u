 ...
 * @create date 2020-09-19 21:30:42
 * @modify date 2020-09-19 21:30:42
 * @desc [Home/Landing Page]
 */
<template>
   <div class="site-wrap">
 
    <div class="site-blocks-cover overlay header-image" 
                ...
                <div class="col-md-9">
                  <div class="row">
                    <div class="col-md-6 mb-3 mb-md-0">
                      <input type="text" v-model="search" @keyup="searchJob" class="mr-3 form-control border-0 px-4" placeholder="job title, keywords or company name ">
                      <div v-if="find">
                        <ul class="list-group row-result">
                          <li class="list-group-item" v-bind:key="job.id" v-for="job in jobs">
                            <router-link style="color:#000" :to="{name: 'jobs', params:{jobs:job}}">{{job.title}}
                            
                             <br>
                                <small class="badge badge-success">{{job.position}}</small> </router-link>
                          </li>
        ...
        <div class="row">
          <div class="col-md-12 mb-5 mb-md-0" data-aos="fade-up" data-aos-delay="100">
            ...
            v-for="job in jobs" :key="job.id">
              ...
              <a href="job-single.html" class="job-item d-block d-md-flex align-items-center  border-bottom"
              :class="job.type">
    ...
    <div class="site-blocks-cover-dream overlay dream-image"  data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-6 text-center" data-aos="fade">
            <h1 class="h3 mb-0 text-white">Your Dream Job</h1>
      ...
      <div class="container">
        ...
        <div class="d-block d-md-flex">
          ...
          <div class="text-center p-4 item" data-aos="fade">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati reprehenderit explicabo quos fugit vitae dolorum.</p>
            <p> <a href="#">Read More 
              <span class="icon-arrow-right small"></span></a></p>
          </div>
        </div>
      </div>
    </div>
